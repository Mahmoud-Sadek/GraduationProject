...
public class SendRequestActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Drawer drawer = new Drawer(getBaseContext(), v, SendRequestActivity.this, "SendRequestActivity");
        drawer.makeDrawer();
        menuAction();
        ...
        mRequestsRecyclerView.setLayoutManager(new GridLayoutManager(SendRequestActivity.this, 1));
    ...
    private static final String JSON_URL = ConstantsFreelance.SERVER + "/get_send_request?";
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, JSON_URL,
                ...
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        Toast.makeText(SendRequestActivity.this, getString(R.string.check_network), Toast.LENGTH_LONG).show();
